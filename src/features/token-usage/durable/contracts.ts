...
import type { TokenUsageLike } from '../core/types.ts'
...
export interface WorkerActivateRunRequest {
  ...
  readonly baselines: ReadonlyArray<{ lifecyclePk: number; sourceRevision: string }>
}
...
export type WorkerCommand =
  ...
  | WorkerBeginRunRequest
  | WorkerActivateRunRequest
  | WorkerMarkRunCleanRequest
  | WorkerGetLastRunRequest
  | WorkerUpsertLifecycleRequest
  | WorkerGetLifecycleRequest
  | WorkerGetCheckpointRequest
  | WorkerGetProjectionProgressRequest
  | WorkerUpdateProjectionProgressRequest
  | WorkerSetProjectionReadyRequest
