// token-usage feature — browser half (ported from dsh-token-dashboard v0.2.0).
//
// Registered by the bundle's composed client entry (src/client/index.ts);
// the plugin-level inject list lives there. Everything else is the source
// implementation.
//
